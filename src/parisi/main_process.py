...
@st.cache_data
def get_parisi_cash_iq(COA_PATH="", GL_PATH="", date_strt="", OUTPUT_XLSX="parisi_output.xlsx", previous_cashiq_path=""):
    ...
    write_output_excel(all_starts, inflows_by_cat, outflows_by_cat, beginning_cash_balance, total_inflows, total_outflows, inflows_present, outflows_present, 
                       acct_info, cash_tx, OUTPUT_XLSX)
