...
def test_trinity_main():
    ...
    excel_bytes = get_trinity_cash_iq(COA_PATH=COA_PATH, GL_PATH=GL_PATH, date_strt=date_strt, OUTPUT_XLSX=OUTPUT_XLSX, previous_cashiq_path=previous_cashiq_path, initial_cash_balance=initial_cash_balance)
