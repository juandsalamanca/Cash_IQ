...
def test_luna_main():
    ...
    excel_bytes = get_cash_iq("Luna", COA_PATH, GL_PATH, "2026-02-26", OUTPUT_XLSX, previous_cashiq_path, 
                                   initial_cash_balance, AR_AGING_PATH=AR_AGING_PATH, 
                                   VENDOR_SUMMARY_PATH=VENDOR_SUMMARY_PATH, cash_floor=cash_floor)
